const dev = {
    ...
    CHECKOUT_TRAVELGENIO_PAGE: 'http://localhost:49506/checkout/hotels/payment/es-ES/201/'
};

const prod = {
    PRODUCT_API: "https://" + window.location.hostname + "/hotels/api/",
    CHECKOUT_API: "https://" + window.location.hostname + "/hotels/api/",
    CHECKOUT_TRAVELGENIO_PAGE: "https://" + window.location.hostname + "/hotels/payment/es-ES/201/"
};
